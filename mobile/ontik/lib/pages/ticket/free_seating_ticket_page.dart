...
class FreeSeatingTicketPage extends StatefulWidget {
  final String ticketCode;
  const FreeSeatingTicketPage({super.key, required this.ticketCode});

  @override
  State<FreeSeatingTicketPage> createState() => _FreeSeatingTicketPageState();
}

class _FreeSeatingTicketPageState extends State<FreeSeatingTicketPage> {
  bool _loading = true;
  String? _error;
        ...
        Container(
          ...
          child: Column(children: [
            ...
            Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                const Icon(Icons.accessibility_new, size: 18, color: AppColors.accent),
                const SizedBox(width: 6),
                Text('Placement libre',
            ...
            if (_data!['zoneNom'] != null) _row(AppLocalizations.of(context)!.clientTicketZone, _data!['zoneNom']),
            if (_data!['typePlace'] != null) _row(AppLocalizations.of(context)!.clientTicketType, _data!['typePlace']),
